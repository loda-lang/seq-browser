...
def get_keyword_descriptions():
    return {
        ...
        'formula-gf': 'Expansions of generating functions',
        'formula-egf': 'Expansions of exponential generating functions',
...
#        'java': 'Java programs (jOEIS) exist for these sequence',
        ...
        'maple': 'Maple programs exist for these sequences',
        'mathematica': 'Mathematica programs exist for these sequence',
